...
def parse_arguments():
    ...
    parser.add_argument('-lr', '--learning_rate', type=float, default= 0.0005315955681660468, help='Learning rate for optimizer')
    parser.add_argument('-wd', '--weight_decay', type=float, default=0.00006747047689015225, help='Weight decay for L2 regularization')
    parser.add_argument('-o', '--optimizer', type=str, choices=['sgd', 'momentum', 'nag', 'rmsprop'], default='rmsprop', help='Optimizer to use')
    parser.add_argument('-nhl', '--num_layers', type=int, default=3, help='Number of hidden layers')
    parser.add_argument('-sz', '--hidden_size', type=int, nargs='+', default=[256, 256, 128], help='Number of neurons in each hidden layer')
